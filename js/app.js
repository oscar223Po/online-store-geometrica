(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".slider-advantage")) new core(".slider-advantage", {
                ...
                pagination: {
                    el: ".controls-advantage__dotts",
                    clickable: true
                },
                navigation: {
                    prevEl: ".advantage-arrows .advantage-arrow_prev",
                    nextEl: ".advantage-arrows .advantage-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".slider-brend")) new core(".slider-brend", {
                modules: [ Pagination, Autoplay, Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: true,
                navigation: {
                    prevEl: ".brend-arrows .brend-arrow_prev",
                    nextEl: ".brend-arrows .brend-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-goods")) new core(".slider-goods", {
                modules: [ Pagination, Autoplay, Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                loop: true,
                pagination: {
                    el: ".controls-goods__dotts",
                    clickable: true
                },
                navigation: {
                    prevEl: ".goods-arrows .goods-arrow_prev",
                    nextEl: ".goods-arrows .goods-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".slider-projects")) new core(".slider-projects", {
                ...
                navigation: {
                    prevEl: ".projects-arrows .projects-arrow_prev",
                    nextEl: ".projects-arrows .projects-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".slider-reviews")) new core(".slider-reviews", {
                ...
                navigation: {
                    prevEl: ".reviews-arrows .reviews-arrow_prev",
                    nextEl: ".reviews-arrows .reviews-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-filter")) new core(".slider-filter", {
                modules: [ Pagination, Autoplay, Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: true,
                navigation: {
                    prevEl: ".filter-arrows .filter-arrow_prev",
                    nextEl: ".filter-arrows .filter-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".images-popular__slider")) {
                new core(".images-popular__slider", {
                    modules: [ Pagination, Autoplay, Navigation, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    spaceBetween: 10,
                ...
                new core(".thumbs-popular", {
                    ...
                    navigation: {
                        prevEl: ".thumbs-arrows .thumbs-arrow_prev",
                        nextEl: ".thumbs-arrows .thumbs-arrow_next"
                    },
                    on: {}
                });
            }
            if (document.querySelector(".slider-product")) {
                ...
                new core(".thumbs-product", {
                    modules: [ Navigation, Thumb, Autoplay ],
                    slidesPerView: 4,
                    spaceBetween: 16,
                    navigation: {
                        prevEl: ".product-arrows .product-arrow_prev",
                        nextEl: ".product-arrows .product-arrow_next"
                    },
                    on: {}
                });
            }
            if (document.querySelector(".slider-variants")) new core(".slider-variants", {
                ...
                speed: 500,
                navigation: {
                    prevEl: ".variants-arrows .variants-arrow_prev",
                    nextEl: ".variants-arrows .variants-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
        ...
        function headerScroll() {
            ...
            const startPoint = header.dataset.scroll ? header.dataset.scroll : 300;
...
***************************************************************************** */
        ...
        const headButton = document.querySelector(".catalog-header__button");
        const headLists = document.querySelector(".catalog-header__lists");
        if (headButton) headButton.addEventListener("click", (() => {
            headLists.classList.toggle("header-catalog-lists-open");
        }));
        aos.init({
            disable: false,
            startEvent: "DOMContentLoaded",
